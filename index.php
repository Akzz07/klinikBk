...
<head>
    ...
    <title>Bimbingan Karir | Memberikan Yang Terbaik untuk Kesehatan Anda</title>
...
<nav class="navbar navbar-expand-lg position-fixed ">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center" href="index.php">
            ...
            <span class="m-0 ms-2 fw-bold text-primary">Bkclinik</span>
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-3 fw-semibold">
                ...
                <li class="nav-item dropdown">
                    ...
                    <span class="m-0 ms-2 fw-bold text-primary">Login</span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="login.php">Dokter</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="loginpas.php">Pasien</a></li>
                    </ul>
                </li>
                <!-- <li class="nav-item">
...
<main role="main" class="container flex-grow-1">
    ...
    <div class="container-lp d-flex flex-column flex-md-row justify-content-center align-items-center">
        <div class="container-left col-12 col-md-6 d-flex flex-column justify-content-center gap-3 mt-4 pt-0 mt-md-5 pt-md-5 p-3 p-md-5 order-2 order-md-1">
            ...
            <?php if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) : ?>
                <a href="loginpas.php " class="btn btn-primary btn-login" >Mau Periksa?</a>
            <?php else : ?>
        ...
        <div class="container-right col-12 col-md-6 d-flex flex-column justify-content-center align-items-center mt-5 pt-5 pb-0 ps-3 pe-3 md-mt-0 md-pt-0 md-pb-0 md-ps-0 md-pe-0 order-1 order-md-2">
            <img src="images/dokter.jpeg" alt="dokter image" class="img-fluid">
        </div>
    </div>
    ...
    <section class="tentang-kami py-5 bg-light">
        <div class="container">
            <div class="row align-items-center d-flex flex-column flex-md-row justify-content-around">
                <div class="col-md-6">
                    <h2 class="mb-4">Tentang <span class="text-primary">Bkclinic</span></h2>
                    <p>Bkclinic adalah poliklinik terpercaya yang berkomitmen untuk memberikan pelayanan kesehatan terbaik bagi masyarakat. Dengan tim dokter berpengalaman dan fasilitas modern, kami siap membantu Anda mencapai kesehatan optimal.</p>
                </div>
                <div class="img-about-container col-md-6 bg-white p-5 rounded mt-5 mt-md-0">
                    <img src="images/logo.jpg" alt="Tentang BK" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </section>
...
<footer class="text-light py-4 mt-5 p-3">
    <div class="container">
        <div class="row">
            ...
            <a class="navbar-brand d-flex align-items-center" href="index.php">
            <img src="images/logo.jpg" alt="Logo" width="30" height="30">
            <span class="m-0 ms-2 fw-bold text-primary fs-4">BKclinik</span>
        </a>
            ...
            <div class="col-md-4">
                ...
                <address>
                    ...
                    <p><i class="bi bi-envelope-fill me-2"></i> info@Bkclinic.com</p>
                </address>
            </div>
        </div>
    </div>
...
<div class="copyright text-center text-light py-3">
    <small>&copy; <?php echo date('Y'); ?> Akmal. All rights reserved.</small>
</div>
